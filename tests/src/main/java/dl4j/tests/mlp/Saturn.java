...
public class Saturn {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String filenameTrain  = new ClassPathResource("saturn-train.csv").getFile().getPath();
        final String filenameTest  = new ClassPathResource("saturn-eval.csv").getFile().getPath();
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(2).nOut(numHiddenNodes)
